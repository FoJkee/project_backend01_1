...
routingPosts.post('/', authorize, postMaddleware, blogidMiddleware, errorsMessages,(req: Request, res: Response) => {
...
routingPosts.put('/:id', authorize, postMaddleware, blogidMiddleware,errorsMessages,(req: Request, res: Response) => {
