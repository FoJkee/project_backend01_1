...
export const blogsMiddleware = [
    ...
    body('websiteUrl').exists().bail().isString().isLength({min: 1, max: 100}).bail().withMessage('String length is not more than 100 symbols').matches(pattern).withMessage('Incorrect websiteUrl')
]